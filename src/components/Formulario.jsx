...
const Formulario = ({setAlert}) => {
    ...
    return (
        <Form className='w-50'  onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-3" >
                <Form.Control type="password" placeholder="Confirma tu contraseña" onChange={(e) => setConfimacionPassword(e.target.value)} value={confimacionPassword}  />
            </Form.Group>
            <Form.Group className="mb-3" >
                <Button className='w-100' as="input" type="submit" value="Registrarse" />
            </Form.Group>
        </Form>
    )
}
